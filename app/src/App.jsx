...
export default function App() {
  ...
  return (
      <div style={{ display: 'flex', position: 'relative' }}>
        <div style={{ position: 'relative' }} className="min-h-screen w-full">
          <DotGrid
              dotSize={4}
              gap={15}
              baseColor="#0d542b"
          ...
          <div style={{ position: 'absolute', pointerEvents: 'none' }} className="relative min-h-screen w-full bg-transparent text-emerald-200">
            ...
            {/* 左上角文字 LOGO */}
            <header className="fixed top-4 left-6 z-40 bg-green-900/40 p-2 rounded-xl">
            ...
            {/* 主体内容 */}
            <main className="flex flex-col items-center justify-center px-6 pt-24 pb-24 mt-12">
              {/* 总请求：主显示卡片 */}
